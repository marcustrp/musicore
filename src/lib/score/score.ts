...
export class Score {
  ...
  constructor(key: Key = new Key('c', 'major'), timeSignature: TimeSignature = new TimeSignature(4, 4)) {
   ...
   */
  addWorkInformation(type: 'composer' | 'lyrics' | 'title' | 'subtitle' | 'history', value: string) {
