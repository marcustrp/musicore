...
describe('addNote', () => {
  it('should class this.bars.addNote with correct parameters @unit', () => {
    ...
    expect(voice['bars'].addNote).toBeCalledWith('P1', 'V1', note, barIndex, beat, { overflow: 'ignore' });
  });
});
...
describe('addNotes', () => {
  it('should class this.bars.addNotes with correct parameters @unit', () => {
    ...
    expect(voice['bars'].addNotes).toBeCalledWith('P1', 'V1', notes, barIndex, beat, ignoreOverflow);
  });
});
...
describe('addTriplet', () => {
  ...
  it('should call notes[0-2].setTriplet with correct parameters @unit', () => {
    ...
    expect(notes[0].setTriplet).toHaveBeenNthCalledWith(1, numerator, denominator, totalDuration, 0, noteCount);
    expect(notes[1].setTriplet).toHaveBeenNthCalledWith(2, numerator, denominator, totalDuration, 1, noteCount);
    expect(notes[2].setTriplet).toHaveBeenNthCalledWith(3, numerator, denominator, totalDuration, 2, noteCount);
  });
