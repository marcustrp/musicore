...
describe('getBarline()', () => {
    ...
    it('should return empty string for unsupported barline', () => {
        const result = generator['getBarline']('unsupported');
        expect(warnings.length).toBe(1);
        expect(result).toBe('');
    });
    it('should return empty string for undefined barline', () => {
        const result = generator['getBarline'](undefined);
        expect(warnings.length).toBe(1);
        expect(result).toBe('');
    });
});
...
describe('getBarAbc()', () => {
    ...
    it('should handle start and end repeats', () => {
        ...
        vi.spyOn(BarGenerator.prototype, 'getBarline').mockReturnValueOnce('|]');
