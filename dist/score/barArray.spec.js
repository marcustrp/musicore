...
describe('appendBar', () => {
    it('should append a bar with same timeSignature and key as last bar @integration', () => {
        ...
        expect(barArray.bars[1]).toEqual(new Bar(new TimeSignature(6, 8), new Key('d', 'minor'), undefined, new Fraction(6, 8)));
    });
    it('should append a bar with provided timeSignature and key @integration', () => {
        ...
        expect(barArray.bars.length).toEqual(2);
        expect(barArray.bars[1]).toEqual(new Bar(new TimeSignature(2, 4), new Key('e', 'major'), undefined, new Fraction(4, 4)));
    });
});
describe('removeBars', () => {
