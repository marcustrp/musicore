...
export type NoteObject = RhythmElementObject & Partial<{
    root: NoteName;
...
export type BarObject = Partial<{
    ...
    notes: {
        [partId: string]: {
            [voiceId: string]: RhythmElementObject[];
        };
    };
}>;
