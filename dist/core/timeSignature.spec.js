...
describe('setBeamGroupDuration()', () => {
    ...
    const initSpy = () => vi
        ...
        .spyOn(TimeSignature.prototype, 'fillBeamGroupDurations')
...
describe('TimeSignature', () => {
    ...
    const initSpy = () => vi
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        .spyOn(TimeSignature.prototype, 'setBeamGroupDuration')
        .mockImplementationOnce((durations) => {
        return durations;
    });
    beforeEach(() => {
    ...
    it('should accept supported symbol "cut"', () => {
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        vi.spyOn(TimeSignature.prototype, 'getBeatsPerBar').mockImplementationOnce(() => 2);
