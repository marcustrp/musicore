 ...
 */
function getAccidental(step, withFormatting = false) {
    switch (step) {
        case -2:
...
const nameToNoteIndex = {};
const noteNumberToNoteIndex = {};
let curStep = 0;
    ...
    for (let j = 0; j < 3; j++) {
        ...
        for (let k = 0; k < stepsToNumber.length; k++) {
            ...
            noteIndexToNameInScale[scaleName][k] = {
                text: naturalNoteNames[(i + lastScaleNumber - 1) % 7].name +
