...
export class Clef {
    ...
    name;
    type;
    constructor(type = 'g', clefLine, octaveChange) {
        if (!(type in defaultClefData))
        ...
        if (defaultClefData[type].name)
            this.name = defaultClefData[type].name;
        if (octaveChange)
