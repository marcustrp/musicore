...
<script lang="ts">
	import { noteAccidentalEventHandler, noteEventHandler } from '../engraver/events/note.js';
	import type {
		KeySignatureAccidentalEvent,
		NoteAccidentalEvent,
		NoteEvent,
	} from '../engraver/events/types.js';
	import type { EngraverSettings } from '../engraver/scoreEngraver.js';
	import type { LayoutSettings } from '../layout/types.js';
	import { BBox } from '../utils/bBox.js';
	import EScore from '../engraver/EScore.svelte';
	import type { Score } from '../score/score.js';
	import { Note, type NoteAccidentals } from '../core/note.js';
	import AccidentalSelector from './gui/AccidentalSelector.svelte';
	import { keySignatureEventHandler } from '../engraver/events/key-signature.js';
